        ...
        <div className="h-[600px] w-full dark:bg-dot-white/[0.2] bg-dot-black/[0.2] relative flex items-center justify-center">
            ...
            <section id='contact' className='container h-full pt-28'>
                <motion.h2 
                    ...
                    className='font-extrabold text-7xl mb-3 text-gray-100'>Ready to transform your business to the next level?
                </motion.h2>
                <motion.p 
                    initial={{opacity: 0, y: 30}}
                    whileInView={{opacity: 1, y: 0}}
                    transition={{duration: 0.5, delay: 0.3}}
                    className='text-2xl mt-7 text-gray-200 font-medium max-w-[700px] leading-[1.6]'>
                ...
                <motion.a 
                    ...
                    <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-slate-950 px-10 py-6 text-2xl font-medium text-white backdrop-blur-3xl">
                        Let's get in touch
                    </span>
                </motion.a>
            </section>
